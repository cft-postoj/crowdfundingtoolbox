...
export class CampaignService {
    ...
    private writeDatesAsStrings(campaign: Campaign): Campaign {
        ...
        result.promote_settings.start_date_value = this.writeDateAsString(campaign.promote_settings.start_date_value);
        result.promote_settings.end_date_value = this.writeDateAsString(campaign.promote_settings.end_date_value);
    ...
    writeDatesAsJson(campaign: Campaign) {
        campaign.promote_settings.start_date_value = this.writeDateAsJson(campaign.promote_settings.start_date_value)
        campaign.promote_settings.end_date_value = this.writeDateAsJson(campaign.promote_settings.end_date_value)
    ...
    writeDateAsJson(date) {
        ...
        const result = {year: +resultArray[0], month: +resultArray[1], day: +resultArray[2]};
        return result;
    }
