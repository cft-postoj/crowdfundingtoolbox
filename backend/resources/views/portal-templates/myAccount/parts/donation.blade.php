<h2 class="cft--is-supported">Thank you for your supporting.</h2>
<h2 class="cft--not-supported">Start to support us, please.</h2>
<p class="cft--mt-20">
    <span class="cft--is-supported">Also thanks to you there is a quality conservative medium with
        a professional editorial office in Slovakia.</span>
    <span class="cft--not-supported">Most of our readers support us. Thanks for joining them.</span>
</p>

<h3 class="cft--mt-20 cft--mb-10">Support detail</h3>
<div class="cft--accountBox cft--accountBox--supporter">
    ...
    <div class="cft--accountBox--supporter--footer">
        <div class="cft--grid--row">
            <div class="cft--grid--lg-10 cft--grid--sm-12">
                <h4>Would you increase support for future of the portal?</h4>
            </div>
            <div class="cft--grid--lg-2 cft--grid--sm-12">
                <a href="/podpora">Increase</a>
            </div>
        </div>
